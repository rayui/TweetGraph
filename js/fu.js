...
// Load the file system module to create an http server.
var readFile = require("fs").readFile;
// Load the sys module for console writing.
var sys = require("sys");
// Load the url module for console writing.
var url = require("url");
DEBUG = false;
...
// function for when url can't be found
...
var server = createServer(function (req, res) {
  if (req.method === "GET" || req.method === "HEAD") {
    // use the url module to parse the incoming URL of the request
    // and find the pathname of the file being accessed.
    // If the file doesn't exist the notFound function is executed
    ...
    res.simpleImage = function(code, body) {
	res.writeHeader(code, "binary", { "Content-Type": "image/jpeg"
				, "Content-Length": body.length
			});
    }
    handler(req, res);
